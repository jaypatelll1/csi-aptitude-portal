...
const Adm_DashboardTiles = ({ item }) => {
  ...
  return (
    <div className="flex items-center bg-white shadow-lg rounded-lg p-5 w-full sm:w-[350px] transform transition-transform duration-300 hover:scale-105 hover:shadow-xl mb-2">
