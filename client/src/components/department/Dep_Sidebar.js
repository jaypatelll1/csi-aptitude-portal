...
const Dep_sidebar = () => {
  ...
  // Check if any test-related route is active
  const isTestRouteActive = [
    "/department/drafted-tests",
    "/department/scheduled-tests", 
    "/department/past-tests",
    "/department/live-tests"
  ].some(path => location.pathname === path);

  // Check if any analytics-related route is active
  const isAnalyticsRouteActive = [
    "/department/analytics",
    "/department/student-analysis"
  ].some(path => location.pathname === path);
    ...
    <div className="fixed left-0 top-0 w-64 h-full p-5 font-sans z-50">
      ...
      <ul className="list-none p-0 m-0">
        ...
        {showSubmenu && (
          <ul className="pl-5 mt-1">
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/drafted-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Drafted Tests</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/scheduled-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Schedule Tests</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/past-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Past Test</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/live-tests" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Live Test</NavLink>
            </li>
          </ul>
        ...
        {showAnalyticsSubmenu && (
          <ul className="pl-5 mt-1">
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/analytics" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
              }>Branch Analytics</NavLink>
            </li>
            <li className="p-1 ml-4 cursor-pointer transition-colors duration-300 hover:text-blue-500">
              <NavLink to="/department/student-analysis" className={({ isActive }) =>
                `${isActive ? "text-blue-500" : "text-black hover:text-blue-500"}`
