...
import Teacher_Sidebar from "../../components/teacher/Teacher_Sidebar"; // Sidebar component
import Teacher_UpcomingTestCard from "../../components/teacher/Teacher_UpcomingTestCard";
import { useSelector } from "react-redux";

const Teacher_UpcomingTest = () => {
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6">
              {paginatedTests.map((test, index) => (
                <Teacher_UpcomingTestCard key={index} test={test} />
              ))}
            </div>
...
export default Teacher_UpcomingTest;
