...
import Teacher_PastCard from "../../components/teacher/Teacher_PastCard";
import { useSelector, useDispatch } from "react-redux";
import Teacher_Sidebar from "../../components/teacher/Teacher_Sidebar";

const Teacher_PastTest = () => {
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6">
                {paginatedTests.map((test, index) => (
                  <Teacher_PastCard key={index} test={test} />
                ))}
              </div>
...
export default Teacher_PastTest;
