            ...
            <div id="main-section" className='ml-64 flex-grow bg-gray-100 h-max'>
                ...
                <div className='flex items-center bg-white h-24 my-6 mx-10 rounded-lg border border-gray-300'>
                    ...
                    <div className='flex ml-auto mr-9'>
                        <div className="bg-[#533FCC] w-40 h-14 rounded-xl flex items-center justify-center mr-5 hover:bg-[#2d2170] transition-all duration-200 cursor-pointer">
                            <h1 className='text-white font-poppins text-lg font-medium leading-normal '>Import Excel</h1>
                        </div>
                        <div onClick={openModal} className="bg-[#533FCC] w-40 h-14 rounded-xl flex items-center justify-center hover:bg-[#2d2170] transition-all duration-200 cursor-pointer">
                            <h1 className='text-white font-poppins text-lg font-medium leading-nor cursor-pointermal '>Add Student</h1>
                        </div>
                    </div>
                </div>
                <div id="listSection" className='bg-white my-6 mx-10 pt-5 pb-5 pl-9 pr-9 rounded-lg border border-gray-300'>
                            ...
                            {filteredStudents.slice((page - 1) * limit, page * limit).map((student, index) => (
                                <tr key={student.user_id} className="hover:bg-gray-50">
                                    ...
                                    <td className="py-4 text-center items-center justify-center flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" viewBox="0 0 25 20" fill="none" className="cursor-pointer fill-[#B4B4B4] hover:fill-gray-500 hover:scale-150 transition-transform duration-10" onClick={() => handleEditOpen(student)()} >
                    ...
                    <div className="flex justify-center items-center mt-5">
                        <svg onClick={handlePrevPage} className="cursor-pointer mr-2" xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none">
                        ...
                        <svg onClick={handleNextPage} className="cursor-pointer ml-2" xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none">
